...
class TripBookedScreen extends StatelessWidget {
  const TripBookedScreen({super.key});
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    // Navigator.push(
                    //     context ,
                    //     MaterialPageRoute(builder: (context) =>   TripDetailsScreen(), maintainState: false));
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
